export const BRIDGE_PATHS = [
  ...
  },
  {
    ...
    tagline: { de: 'Vollzeitschulische Berufsausbildung', en: 'Full-time vocational school' },
    meta: { de: '1–3 Jahre · staatlich anerkannt · kein Betrieb nötig', en: '1–3 years · state-recognised · no employer required' },
    description: {
      de: 'Die Berufsfachschule ist eine vollzeitschulische Ausbildung ohne Betrieb — du wirst an einer berufsbildenden Schule (OSZ) ausgebildet und erhältst einen staatlich anerkannten Abschluss. Geeignet für Berufe in Pflege, Soziales, Handel oder Technik. Keine Suche nach Ausbildungsbetrieb nötig.',
      en: 'A full-time vocational school programme with no employer required — you train at a state school (OSZ) and earn a state-recognised qualification. Suited for care, social work, retail, or technical fields. No need to find a training company.',
    },
    difficulty: 'medium',
    timeToStart: { de: 'Ab August (Anmeldung bis Februar–April)', en: 'From August (register by February–April)' },
    riasecFit: ['S', 'R', 'C'],
    incomeFit: 'low',
    typical_day: { de: 'Vollzeitschule am OSZ + Praktika', en: 'Full-time school at OSZ + practical placements' },
    income_now: { de: 'Keins (BAföG oder Kindergeld möglich)', en: 'None (BAföG or Kindergeld possible)' },
    freedom: { de: 'Gering — fester Schulbetrieb', en: 'Low — fixed school schedule' },
    flexibility: { de: 'Fachrichtung wechseln möglich', en: 'Can switch subject area' },
    outlook: { de: 'Direkter Berufseinstieg oder weiterführende Ausbildung', en: 'Direct job entry or further vocational training' },
    minCert: 'Hauptschulabschluss',
    clusters: ['people', 'hands-on', 'business'],
    stories: [],
    nextSteps: {
      de: [
        'Such ein OSZ mit dem Berufsfachschulzweig, der dich interessiert — z.B. Pflege, Handel oder Technik',
        'Meld dich vor Ende April an — Plätze sind begrenzt',
        'Frag bei der JBA Neukölln (Sonnenallee 282, 12057 Berlin) nach passenden Schulen',
      ],
      en: [
        'Find an OSZ offering the Berufsfachschule subject you\'re interested in — e.g. care, retail, or technical',
        'Register by end of April — places are limited',
        'Ask at JBA Neukölln (Sonnenallee 282, 12057 Berlin) for suitable schools',
      ],
    },
    human_story: {
      name: 'Fatima, 17',
      quote: {
        de: 'Ich wollte in die Pflege, aber hatte noch keinen Ausbildungsplatz gefunden. Die Berufsfachschule hat mir ermöglicht, direkt zu starten — ohne Betrieb suchen zu müssen. [NEEDS REAL QUOTE]',
        en: 'I wanted to get into care work but hadn\'t found a training company. The Berufsfachschule let me start right away — no employer search needed. [NEEDS REAL QUOTE]',
      },
      detail: {
        de: 'Fatima absolviert gerade die zweijährige Berufsfachschule für Sozialassistenz und plant danach eine Erzieherausbildung.',
        en: 'Fatima is currently completing the two-year Berufsfachschule for social assistance and plans to do an Erzieherin training afterwards.',
      },
    },
  },
  {
    ...
    tagline: { de: 'Kunstakademie / Designhochschule', en: 'Art & Design University' },
    meta: { de: '4–5 Jahre · kein NC · Aufnahmeprüfung + Portfolio', en: '4–5 years · no grade cutoff · entrance exam + portfolio' },
    description: {
      de: 'Kunsthochschulen (wie die UdK Berlin oder weißensee kunsthochschule) vergeben keine Plätze nach Abiturnote (kein NC), sondern nach einem persönlichen Portfolio und einer Aufnahmeprüfung. Offen für Menschen mit Abitur — und in Ausnahmefällen auch mit Fachabitur oder Berufsausbildung.',
      en: 'Art universities (such as UdK Berlin or weißensee kunsthochschule) admit students based on a personal portfolio and entrance exam — not grades (no NC). Open to Abitur holders and, in exceptional cases, those with Fachabitur or a completed vocational training.',
    },
    difficulty: 'hard',
    timeToStart: { de: 'Ab Oktober (Bewerbung Nov–Jan für das folgende Jahr)', en: 'From October (apply Nov–Jan for the following year)' },
    riasecFit: ['A', 'I', 'E'],
    incomeFit: 'low',
    typical_day: { de: 'Atelierarbeit, Projekte, Crits (Korrekturen), Ausstellungen', en: 'Studio work, projects, critiques, exhibitions' },
    income_now: { de: 'Keins (BAföG möglich · Nebenjob üblich)', en: 'None (BAföG possible · part-time job typical)' },
    freedom: { de: 'Hoch — viel Eigenverantwortung für Projekte', en: 'High — lots of self-directed project work' },
    flexibility: { de: 'Schwerpunkt im Studium wählbar', en: 'Can choose specialisation within the programme' },
    outlook: { de: 'Freie Kunst, Design, Kommunikation, Lehre', en: 'Fine art, design, communication, teaching' },
    minCert: 'Fachhochschulreife',
    clusters: ['creative', 'people', 'analytical'],
    stories: [],
    nextSteps: {
      de: [
        'Bau ein starkes Portfolio — 15–20 Arbeiten, die zeigen, wie du denkst, nicht nur was du kannst',
        'Schau dir die Anforderungen der UdK Berlin (udk-berlin.de) und weißensee (kh-berlin.de) an',
        'Besuche einen Tag der offenen Tür — die Aufnahmeprüfung ist sehr persönlich',
        'Fang früh an: Viele Bewerber brauchen 2–3 Anläufe',
      ],
      en: [
        'Build a strong portfolio — 15–20 pieces that show how you think, not just what you can do',
        'Check the requirements at UdK Berlin (udk-berlin.de) and weißensee (kh-berlin.de)',
        'Visit an open day — the entrance exam is very personal',
        'Start early: many applicants need 2–3 attempts',
      ],
    },
    human_story: {
      name: 'Lina, 20',
      quote: {
        de: 'Meine Noten waren gut, aber nicht gut genug für BWL an der Uni. Die Kunsthochschule hat sich nie nach einer zweiten Wahl angefühlt — es war von Anfang an genau das Richtige. [NEEDS REAL QUOTE]',
        en: 'My grades were fine but not good enough for business at university. Art school never felt like a fallback — it was the right choice from the start. [NEEDS REAL QUOTE]',
      },
      detail: {
        de: 'Lina studiert Kommunikationsdesign an der weißensee kunsthochschule Berlin. Sie hat nach zwei Bewerbungsrunden einen Platz bekommen.',
        en: 'Lina studies communication design at weißensee kunsthochschule Berlin. She got a place after two application rounds.',
      },
    },
  },
];
...
export const ALL_PATHS = [
  {
    ...
    income_now: { de: '600–900 €/Monat (Ausbildung) · 1.800–2.800 €/Monat (nach Abschluss)', en: '600–900 €/mo (training) · €1,800–2,800/mo (after qualifying)' },
    careerExamples: { de: 'KFZ-Mechatroniker/in · Kauffrau/-mann · Fachinformatiker/in · Elektroniker/in', en: 'Vehicle mechanic · Sales specialist · IT specialist · Electrician' },
  ...
  },
  {
    ...
    income_now: { de: '~350 €/Monat + Unterkunft (Taschengeld; kein Gehalt)', en: '~350 €/mo + housing (pocket money; not a salary)' },
    careerExamples: { de: 'Erzieher/in · Pflegefachkraft · Sozialarbeiter/in · Physiotherapeut/in', en: 'Childcare worker · Care professional · Social worker · Physiotherapist' },
  ...
  },
  {
    ...
    income_now: { de: 'Variabel — 0 bis unbegrenzt (erste 3–6 Monate oft 0)', en: 'Variable — 0 to open (first 3–6 months often €0)' },
    careerExamples: { de: 'Grafik-Designer/in · Web-Developer · Content Creator · Fotograf/in · Texter/in', en: 'Graphic designer · Web developer · Content creator · Photographer · Copywriter' },
  ...
  },
  {
    ...
    income_now: { de: '~1.400 €/Monat (Freiwilliger Wehrdienst) · 1.800–2.800 €/Monat (SaZ-Vertrag)', en: '~1,400 €/mo (voluntary service) · €1,800–2,800/mo (fixed-term contract)' }, // UNVERIFIED — verify current Bundeswehr pay grades
    careerExamples: { de: 'IT-Spezialist/in Bundeswehr · Sanitätssoldatin / -soldat · Piloten-Laufbahn · Zivile Übernahme nach Dienstzeit', en: 'Bundeswehr IT specialist · Medic · Pilot career track · Civilian transfer after service' },
  ...
  },
  {
    ...
    income_now: { de: 'Selbst finanziert · Working Holiday: 1.200–2.000 €/Monat möglich', en: 'Self-funded · Working Holiday: €1,200–2,000/mo possible' },
    careerExamples: { de: 'Hängt davon ab, was danach kommt — Gap Year ist kein Berufsziel, sondern Orientierung', en: 'Depends on what follows — a gap year clarifies direction, not a career end-point' },
