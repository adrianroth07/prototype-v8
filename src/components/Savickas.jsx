      ...
      <div className="hidden md:flex bg-gradient-to-b from-pf-primary to-pf-dark text-white p-14 md:w-[400px] flex-col justify-center relative overflow-hidden">
        ...
        <Reveal>
          <div className="relative">
            ...
            <h1 className="font-heading text-3xl font-bold mb-3 tracking-tight">{t.savickas.title}</h1>
            <p className="text-pf-mid text-base leading-relaxed">{t.savickas.subtitle}</p>
          </div>
        </Reveal>
      </div>
